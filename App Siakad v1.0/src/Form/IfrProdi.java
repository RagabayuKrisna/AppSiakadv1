...
public class IfrProdi extends javax.swing.JInternalFrame {
    ...
    private void settTableProdi(){
        ...
        tbDataProdi.getColumnModel().getColumn(1).setPreferredWidth(225);
    ...
    private void aksiSimpan(){
        vkd_jur = KeyJurursan[cmbJurusan.getSelectedIndex()];
    ...
    private void listJurusan(){
        try{
            ...
            res.first();
            KeyJurursan = new String[i+1];
            for(Integer x = 1; x < i; x++){
                KeyJurursan[x] = res.getString(1);
                res.next();
            }
        }catch(SQLException ex){
    ...
    private void initComponents() {
        ...
        txtKdProdi.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "ID. Prodi :"));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if(cmbJurusan.getSelectedIndex()<=0){
            JOptionPane.showMessageDialog(this, "Jurursan harus dipilih","Informasi",JOptionPane.INFORMATION_MESSAGE);
